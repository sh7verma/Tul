...
public class AddBankDetailActivity extends BaseActivity {
    ...
    protected void initUI() {
        ...
        txtToolbarTitle.setText(R.string.add_bank_detail);

        txtSkip.setTextSize(TypedValue.COMPLEX_UNIT_PX, (float) (mWidth * 0.045));
...
//            llCurrency.setOnClickListener(this);
    ...
    protected Context getContext() {
        return AddBankDetailActivity.this;
    }
...
//                selectOptions(getCountry(), COUNTRY, txtCountryCodeValue.getText().toString());
                if (txtCurrencyValue.getText().equals("EUR")) {
...
//        RequestBody country_code = RequestBody.create(MediaType.parse("text/plain"), txtCountryCodeValue.getText().toString());
