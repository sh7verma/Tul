...
public class BlueCirclePageIndicator extends View implements PageIndicator {
    ...
    public BlueCirclePageIndicator(Context context) {
        this(context, null);
    }

    public BlueCirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public BlueCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
