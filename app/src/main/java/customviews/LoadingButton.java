...
public class LoadingButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mTextColor = ta.getColor(R.styleable.LoadingButton_lb_textColor, Color.BLACK);
        ...
        Typeface typeface = Typeface.createFromAsset(context.getAssets(), "fonts/semibold.ttf");
