...
/**
 * Created by applify on 10/6/2017.
 */

public class LoadingButtonFacebook extends View {
    ...
    public LoadingButtonFacebook(Context context) {
        super(context);
        init(context, null);
    }

    public LoadingButtonFacebook(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LoadingButtonFacebook(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            int defaultColor = ContextCompat.getColor(context, R.color.facebook);
            ...
            mRippleColor = ta.getColor(R.styleable.LoadingButton_lb_btnRippleColor, ContextCompat.getColor(context, R.color.hint_color_light));
    ...
    public void setTextSize(int typeface) {
        mTextPaint.setTextSize(typeface);
        invalidate();
    }
        ...
        set.addListener(new LoadingButtonFacebook.AnimatorEndListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (mAnimationEndListener != null) {
                    mAnimationEndListener.onAnimationEnd(LoadingButton.AnimationType.SUCCESSFUL);
                }
            }
        });
        set.start();
    ...
    private void playFailedAnimation() {
        ...
        failedAnimator.setDuration(100);
        ...
        failedAnimator2.setDuration(100);
        ...
        set.addListener(new LoadingButtonFacebook.AnimatorEndListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (mAnimationEndListener != null) {
                    mAnimationEndListener.onAnimationEnd(LoadingButton.AnimationType.FAILED);
                }
            }
        });
        set.start();
    ...
    public interface AnimationEndListener {
        void onAnimationEnd(LoadingButton.AnimationType animationType);
    }
}
