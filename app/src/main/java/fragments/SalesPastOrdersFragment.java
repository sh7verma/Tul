...
public class SalesPastOrdersFragment extends Fragment implements View.OnClickListener, HistoryRatingListener {
    ...
    public void onResume() {
        super.onResume();
        RateYourExperienceActivity.RatingInterfacePast(this);
    }
    ...
    private void hitAPI() {
        Call<SalesHistoryTulDetailModel> call =
                RetrofitClient.getInstance().sale_histories(util.getString("access_token", ""), "2", mOffset);
...
//        Call<LentTulModel> call = RetrofitClient.getInstance().getRentedTul(util.getString("access_token", ""), mOffset);
...
//
    ...
    public void onRatingGiven() {
        hitAPI();
//        Toast.makeText(mContext, "past", Toast.LENGTH_SHORT).show();
    }
}
