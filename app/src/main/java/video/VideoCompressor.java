...
import videoUtils.AppUtil;
import videoUtils.SGLog;
import videoUtils.VideoUtil;
...
//    private static String mOutputFile = AppUtil.getAppDir() + "/video_compress.mp4";
    ...
    private static String mStrCmd = " -strict -2 -s 480x480 -r 24 -vcodec mpeg4 -b:v 1000k -b:a 72k -ac 1 -ar 44100 "; // ok quality, high compression
    private static String mStrCmdPre = "ffmpeg -y -i ";
    private static String mOutputFile = AppUtil.getAppDir() + "/video_compress.mp4";
    ...
    private static void init(Context context){
        ...
        GeneralUtils.copyLicenseFromAssetsToSDIfNeeded((Activity) context, workFolder);
        GeneralUtils.copyDemoVideoFromAssetsToSDIfNeeded((Activity)context, demoVideoFolder);
...
//                            listener.onProgress(100);
    ...
    private static void compressByFFmpeg(Context context,String inputFile,final VideoCompressListener listener) {
      //  SGLog.e("runTranscodingUsingLoader started...");
        ...
        System.out.println("runTranscodingUsingLoader started...");
        vk = new LoadJNI();
