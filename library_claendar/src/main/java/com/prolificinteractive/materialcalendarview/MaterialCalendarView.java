...
public class MaterialCalendarView extends ViewGroup {
    ...
    public static ArrayList<CalendarDay> mCalenderDisabledDates = new ArrayList<>();
        ...
        public void onClick(View v) {
            if (v == buttonFuture) {
                if (isForwardEnabled)
                    ...
                    Toast.makeText(mContext, "This is exceeding the maximum days limit for selection. You can select maximum 99 days.", Toast.LENGTH_SHORT).show();
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        typeface = Typeface.createFromAsset(context.getAssets(), "fonts/semibold.ttf");
...
//        buttonFuture.setEnabled(canGoForward());
     ...
     */
    public void setHeaderTextAppearance(int resourceId, Typeface typeface) {
...
//                    nowSelected=true;
                    ...
                    if (!isSelected) {
                        Log.e("Dates = ", dates.get(0) + " " + dates.get(1));
                        ...
                        for (int i = 0; i < mCalenderDisabledDates.size(); i++) {
                            if (dates.contains(mCalenderDisabledDates.get(i))) {
                                clearSelection();
                                nowSelected = false;
                                isSelected = false;
                                dispatchOnDateSelected(date, nowSelected);
